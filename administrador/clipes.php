<!DOCTYPE html>
  <html lang="pt-br">
	...
	<?php 
		...
		$link = 'clipes.php';
		$sql = "SELECT * FROM `Clipes`";
	?>

  <head>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=2.0"/>
    <title>Administrador &mdash; Clipes</title>
    ...
    <main>
      <div class="section">
        <div class="container">
          <div class="row">
            <div class="col s12">
              <h3 class="center  grandma purple-title">Clipes</h3>
            </div>
          </div>
					<div class="row">
							<div class="col s12">
																	...
																	<div class="modal-content">
																			<center>
																					...
																					<form action="acao.php" method="post">
																							...
																							<div class="input-field col s12">
																									<input id="linkClipe" type="text" name="linkClipe" />
																									<label for="linkClipe">Link</label>
																							</div>
																							<center>
																			...
																			<div class="modal-content">
																					<center>
																							...
																							<form action="acao.php" method="post">
																									...
																									<div class="input-field col s12">
																											<input id="linkClipe" type="text" name="linkClipe" value="<?php echo $row['link']; ?>" />
																											<label for="linkClipe">Link</label>
																									</div>
																									<center>
																											<input type="hidden" name="tabela" value="<?php echo $tabela; ?>">
